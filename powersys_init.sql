...
CREATE TABLE IF NOT EXISTS `DATA_0C33` (
  ...
  `M_USERKWH` varchar(256) DEFAULT NULL COMMENT '正向有功费率1-M示值,#分隔',
  `M_DEVKVAR` varchar(256) DEFAULT NULL COMMENT '正向无功费率1-M示值,#分隔',
  `M_FIRSTKVAR` varchar(256) DEFAULT NULL COMMENT '一象限无功费率1-M示值,#分隔',
  `M_FOURKVAR` varchar(256) DEFAULT NULL COMMENT '四象限无功费率1-M示值,#分隔',
  PRIMARY KEY  (`ID`),
